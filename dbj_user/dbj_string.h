...
static void dbj_string_test() 
{
	...
	// thus sub(5,7) is '567'
	char zero_nine[] = "1234567890";
	char four_six[]  = "1234567890";
	...
	size_t where1 = dbj_p_is_in_range("3", o2z);
	// this yields 2
	size_t where2 = dbj_p_is_in_range(o2z->front + 2, o2z);
	// this yields 2
	size_t where3 = dbj_c_is_in_range('3', o2z);
	/*
